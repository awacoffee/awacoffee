                ...
                <div class="pc_stores_cards store_lists">
                    ...
                    <article class="stores_card">
                        <a href="#">
                            <div class="front_card">
                                <figure class="stores_img">
                                    <img class="card_img" src="./assets/img/test_06.jpg" alt="" />
                                </figure>
                                <div class="stores_tags">
                                    <p class="stores_tag">
                                        シチュエーション別
                    ...
                    <article class="stores_card">
                        <a href="#">
                            <div class="front_card">
                                <figure class="stores_img">
                                    <img class="card_img" src="./assets/img/test_07.jpg" alt="" />
                                </figure>
                                <div class="stores_tags">
                                    <p class="stores_tag">
                                        シチュエーション別
                    ...
                    <article class="stores_card">
                        <a href="#">
                            <div class="front_card">
                                <figure class="stores_img">
                                    <img class="card_img" src="./assets/img/test_08.jpg" alt="" />
                                </figure>
                                <div class="stores_tags">
                                    <p class="stores_tag">
                                        シチュエーション別
            ...
            <div class="store_area">
                ...
                <div class="sp_stores_cards store_lists">
                    <article class="stores_card">
                        <a href="#">
                            <figure>
                                <img class="card_img" src="./assets/img/4-3img.jpg" alt="" />
                            </figure>
                            <div class="text_inner">
                                <h3 class="stores_name">
                                    とよとみ珈琲
