                ...
                <div class="header_wrap_box">
                    ...
                    <nav>
                        <ul class="header_nav_list">
                            ...
                            <li>
                                <a href="https://awa-coffee.com/column_category/beginner/" class="header_nav_item">コーヒー入門知識</a>
                            </li>
                            <li>
                                <a href="https://awa-coffee.com/column_category/blog/" class="header_nav_item">ブログ</a>
                            </li>
                            <li>
                                <a href="https://awa-coffee.com/column_category/special/" class="header_nav_item">特集</a>
                            </li>
                            <li>
                ...
                <div class="inner">
                    <nav class="drower_nav">
                        ...
                        <ul class="drower_nav_box">
                            <li>
                                <a href="https://awa-coffee.com/purpose/drink/" class="drower_nav_box_item">店で飲みたい</a>
                            </li>
                            <li>
                                <a href="https://awa-coffee.com/purpose/beans/" class="drower_nav_box_item">豆を買いたい</a>
                            </li>
                        </ul>
                        <ul class="drower_nav_list">
                            ...
                            <li>
                                <a href="https://awa-coffee.com/column_category/beginner/" class="drower_nav_item">コーヒー入門知識</a>
                            </li>
                            <li>
                                <a href="https://awa-coffee.com/column_category/blog/" class="drower_nav_item">ブログ</a>
                            </li>
                            <li>
                                <a href="https://awa-coffee.com/column_category/special/" class="drower_nav_item">特集</a>
                            </li>
                            <li>
                            ...
                            <li>
                                <a href="https://www.instagram.com/awa_our_coffee_hour/" class="drower_nav_item"><i class="fa-brands fa-instagram fa-2x"></i></a>
                            </li>
                        </ul>
                    </nav>
                </div>
